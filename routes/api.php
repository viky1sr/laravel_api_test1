...
Route::group(['prefix' => 'v1'], function() {
    ...
    Route::group(['middleware' => 'jwt'], function (){
        ...
        Route::get('report-transaksi','Api\LogPembelianCustomerApiController@getRepotrs')->middleware('role:admin');
        /*end:Admin Role*/

        Route::get('/products','Api\ProductApiController@getAll');
        Route::get('/admin-fee','Api\ProductApiController@getAllFee');

        Route::group(['prefix' => 'pembelian-customers'], function () {
            /*Admin Role*/
            Route::group(['middleware' => 'role:admin'],function(){
                Route::get('/','Api\LogPembelianCustomerApiController@getAll');
                Route::delete('/{id}','Api\LogPembelianCustomerApiController@destroy');
                Route::get('/{id}','Api\LogPembelianCustomerApiController@getById');
            });
            /*end:Admin Role*/

            Route::get('/my/{customer_id}','Api\LogPembelianCustomerApiController@getMyLog');
            Route::post('/','Api\LogPembelianCustomerApiController@create');
        });
